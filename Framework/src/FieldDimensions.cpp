...
FieldDimensions::FieldDimensions() : Boundary<>(0,0) {
}
...
void FieldDimensions::drawPolygons(RoboCup::uint32 ownColor) const
{
  ...
  COMPLEX_DRAWING("field polygons", Vector2<>* points = new Vector2<>[carpetBorder.lines.size()];
  ...
  CIRCLE("field polygons", xPosOwnGoalpost, yPosLeftGoal, 50, 0, Drawings::ps_solid, own, Drawings::bs_solid, own);
  CIRCLE("field polygons", xPosOwnGoalpost, yPosRightGoal, 50, 0, Drawings::ps_solid, own, Drawings::bs_solid, own);
  own.a = 100;
  Vector2<> goal[4];
  ...
  CIRCLE("field polygons", xPosOpponentGoalpost, yPosLeftGoal, 50, 0, Drawings::ps_solid, opp, Drawings::bs_solid, opp);
  CIRCLE("field polygons", xPosOpponentGoalpost, yPosRightGoal, 50, 0, Drawings::ps_solid, opp, Drawings::bs_solid, opp);
  opp.a = 100;
